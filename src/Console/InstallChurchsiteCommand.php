...
use Bishopm\Churchsite\Models\Household;
use Bishopm\Churchsite\Models\Individual;
use Spatie\Permission\Models\Role;
use Spatie\Permission\Models\Permission;
use Illuminate\Support\Facades\DB;

class InstallChurchsiteCommand extends Command
{
    protected $signature = 'churchsite:install';
    protected $description = 'Initial setup of Churchsite Application';
    ...
    protected function seeder($newuser)
    {
        ...
        DB::table('tags')->insert([
            'namespace' => 'Bishopm\Churchsite\Models\Individual',
            'slug' => 'preacher',
            'name' => 'preacher'
        ]);
        DB::table('tags')->insert([
