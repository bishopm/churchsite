...
use Bishopm\Churchsite\Repositories\SettingsRepository;
...
class LoginController extends Controller
{
    ...
    */
    ...
    public function showLoginForm()
    {
        ...
        return view('churchsite::auth.login', compact('churchname'));
    }
    ...
    public function handleProviderCallback($social)
    {
        ...
        if ($user) {
            ...
            return view('churchsite::auth.register', ['name' => $userSocial->getName(), 'email' => $userSocial->getEmail(), 'individuals'=>$individuals, 'services'=>$services, 'provider'=>$social, 'provider_id'=>$provider_id]);
        }
    }
}
