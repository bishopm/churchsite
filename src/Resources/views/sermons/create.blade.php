            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Readings" name="readings" id="readings" type="text">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Video url" name="video" id="video" type="text">
                    </div>
                    <div class="form-group">
